...
<html>
	...
	<script>
		...
		function updateOperate(value,row,index){
			...
			var html="";
			html=html+"<gd:btn btncode='XTYHGL002'><a class='operate' href='javascript:;' onclick=updateAction('"+row.userID+"');>修改</a></gd:btn>"
			         +"<gd:btn btncode='XTYHGL008'><a class='operate' href='javascript:;' onclick=assignRole('"+row.userID+"');>分配角色</a></gd:btn>"
			return html;
		}
...
<body>
	<table id="dg" title="">
		<thead>
			<tr>
				...
				<th data-options="field:'mobile',width:150,align:'center',sortable:true">联系电话</th>
	...
	<div id="tb" style="padding:5px;height:auto">
        ...
        <div style="margin-top:10px;">
			...
			<gd:btn btncode="XTYHGL007"><a class="easyui-linkbutton" iconCls="icon-search" onclick="query()">查询</a>&nbsp;&nbsp;</gd:btn>
			<a class="easyui-linkbutton" iconCls="icon-reload" onclick="cleardata()">重置</a>
			
		</div>
		</form>
		<div style="margin-bottom:5px">
			<gd:btn btncode="XTYHGL001"><a class="easyui-linkbutton" iconCls="icon-add" onclick="addAction()">新增</a></gd:btn>
			<gd:btn btncode="XTYHGL003"><a class="easyui-linkbutton" iconCls="icon-remove" onclick="delObj()">删除</a></gd:btn>
			<gd:btn btncode="XTYHGL004"><a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="updateStatus('0')">启用</a></gd:btn>
			<gd:btn btncode="XTYHGL005"><a class="easyui-linkbutton" data-options="iconCls:'icon-no'" onclick="updateStatus('1')">禁用</a></gd:btn>
			<gd:btn btncode="XTYHGL006"><a class="easyui-linkbutton" data-options="iconCls:'icon-redo'" onclick="resetPwd()">重置密码</a></gd:btn>
