...
<body>
	...
	<div id="demotb" style="padding:5px;height:auto">
		...
		<div>
			<table>
				<tr>
					<td style="float:right">企业名称：</td>
					<td><input type="text" id="companyName" name="companyName" style="width:150px" placeholder="请输入企业名称" maxlength="30"/>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>申请时间：</td>
					<td>
		...
		<div style="background:#efefef;width: 1129px;height: 40px">
		    <div style="float:left;font-size:14px;margin-left:5px;margin-top:9px">企业认证列表</div>
		    <div style="float:left;margin-top:8px">
		        <gd:btn btncode="QYRZ01"><input id="hid_showInfo" type="hidden" value="0" /></gd:btn>
			    <gd:btn btncode="QYRZ02"><a id="auditData" class="easyui-linkbutton" >审核</a></gd:btn>
				<gd:btn btncode="QYRZ03"><a id="exportData" class="easyui-linkbutton" iconCls="icon-account-excel">导出</a></gd:btn>
			</div>
		</div>
...
<script type="text/javascript" src="${CONTEXT}js/memberCer/companyCer.js"></script>
</html>