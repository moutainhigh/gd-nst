...
// 			 });
    ...
    <style>
    	...
    	.layout-panel-west{margin-left: 40px; left:-45px !important;}
    	#my_layout{background-color: #f4f6f8;}
    	/* .layout-panel-center{margin-left: 70px !important; left:170px !important;} */
    ...
    <div id="my_layout" class=" <c:if test="${sysType eq 'purchase' }">ska</c:if><c:if test="${sysType eq 'school' }">skc</c:if><c:if test="${sysType eq 'base' }">skb</c:if>" >
        ...
        <!-- <div class="container"> -->
        	<div  region="west" split="false" class="menu-main" id="menuContainer" style="width:210px;">
    			<div class="menu-title" style="	text-align: left;padding-left: 15px;background-color: #4e95d2;height:45px;">农速通运营管理后台</div>
				<div class="menu-list">
					<ul style="">
            ...
            <div data-options="region:'center'" class="main" style="border: 1px solid #ddd;">
            	<div style="">
            		<div id="my_tabs">
						<div title="农速通-后台管理系统" data-options="border:false" class="index_bg">
							<!-- 默认打开第一个菜单 -->
							<div align="center">
								<%-- <jsp:include page="wel.jsp"></jsp:include> --%>
								<img src="${CONTEXT }images/333_03.jpg"/>
							</div>
						</div>
					</div>
            	</div>
