...
<div style="margin: 10px auto;width:80%">
	<form action="" id="editAdBannerForm">
		<input type="hidden" name="id" value="${dto.id }"/>
		<table>
			<tr>
				<td>广告名称：</td>
				<td><input type="text" name="name" id="name" style="width:153px" value="${dto.name }" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
			</tr>
			<tr>
				<td>广告渠道：</td>
				<td><select name="channel" id="channel" style="width:158px" class="easyui-validatebox" required="true">
						<option value="">请选择广告渠道</option>
			...
			<tr>
				<td>广告类型：</td>
				<td><select name="type" id="type" style="width:158px" class="easyui-validatebox" required="true">
						<option value="">请选择广告类型</option>
						<c:forEach var="type" items="<%=cn.gdeng.nst.enums.AdBannerTypeEnum.values() %>">
							<option value="${type.code }" ${dto.type == type.code ? "selected" : ""}>${type.name}</option>
						</c:forEach>
					</select>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
				...
				<td><input type="text" id="startTime"
					...
					name="startTime" style="width: 153px;" value="<fmt:formatDate value='${dto.startTime }' pattern='yyyy-MM-dd HH:mm:ss'/>" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td>结束时间:</td>
				<td><input type="text" id="endTime"
					...
					name="endTime" style="width: 153px;" value="<fmt:formatDate value='${dto.endTime }' pattern='yyyy-MM-dd HH:mm:ss'/>" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td>排序：</td>
				<td><input type="text" name="sort" id="sort" style="width:153px" value="${dto.sort }" validtype="number" class="easyui-validatebox"/></td>
			</tr>
			<tr>
				<td>上传图片:</td>
				<td>
					<div class="user-iteam">
				        ...
				        <div class="form-context">
				            ...
				            <c:set var="imgUrlStr" value='[{"url":"${dto.imgUrl }"}]'/>
