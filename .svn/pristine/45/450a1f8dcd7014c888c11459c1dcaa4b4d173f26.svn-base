...
<script type="text/javascript">
	...
	function rowButtonFormater(value,row,index){
		var html="";
		html=html+"<gd:btn btncode='XTANGL002'><a class='operate' href='javascript:;' onclick=updateButAction('"+row.btnID+"');>修改</a></gd:btn>";
		html=html+"<gd:btn btncode='XTANGL003'><a class='operate' href='javascript:;' onclick=deleteButAction('"+row.btnID+"');>删除</a></gd:btn>";
		return html;
	}
...
<body class="easyui-layout">
	<div data-options="region:'north'" style="padding-top: 10px;background: #fafafa;border-color: #ddd;">
		...
		<div style="margin-bottom:5px;padding-left: 10px;">
			<gd:btn btncode="XTANGL001"><a class="easyui-linkbutton" iconCls="icon-add" onclick="addButtonObj()">新增</a></gd:btn>
			<gd:btn btncode="XTANGL003"><a class="easyui-linkbutton" iconCls="icon-remove" onclick="delButtonObj()">删除</a></gd:btn>
