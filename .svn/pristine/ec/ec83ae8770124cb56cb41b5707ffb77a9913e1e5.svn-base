...
import cn.gdeng.nst.admin.service.right.SysRegisterUserService;
import cn.gdeng.nst.admin.service.right.SysUserRoleService;
import cn.gdeng.nst.entity.nst.SysRegisterUser;
import cn.gdeng.nst.util.admin.web.LoginUserUtil;
import cn.gdeng.nst.util.admin.web.StringUtil;
import cn.gdeng.nst.util.web.api.CommonConstant;
import cn.gdeng.nst.util.web.api.CommonConstant.UserLowType;
import cn.gdeng.nst.util.web.api.CommonConstant.UserType;
import cn.gdeng.nst.util.web.api.GdProperties;
import cn.gdeng.nst.util.web.api.IdCreater;
