...
<body>
	...
	<div id="demotb" style="padding:5px;height:auto">
		...
		<div style="margin-bottom:5px">
			<xlc:btn btncode='XZ001'><a id="btn001" class="easyui-linkbutton icon-add-btn" iconCls="icon-add">ajax正常展示</a></xlc:btn>
			<xlc:btn btncode='XZ001'><a id="btn002" class="easyui-linkbutton icon-add-btn" iconCls="icon-add">ajax异常消息展示</a></xlc:btn>
			<xlc:btn btncode='XZ001'><a id="btn003" class="easyui-linkbutton icon-add-btn" iconCls="icon-add">ajax服务器异常展示</a></xlc:btn>
		</div>
