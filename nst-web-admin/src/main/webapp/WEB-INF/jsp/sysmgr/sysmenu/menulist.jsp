...
<html>
	...
	<script>
		...
		function rowformater(value,row,index){
			var html="";
			html=html+"<gd:btn btncode='XTCDGL002'><a class='operate' href='javascript:;' onclick=updateAction('"+row.menuID+"');>修改</a></gd:btn>";
...
<body >
		<div id="tb" style="padding:5px;height:auto">
			...
			<div>
				...
				<gd:btn btncode="XTCDGL004"><a class="easyui-linkbutton" iconCls="icon-search" onclick="query()">查询</a>&nbsp;&nbsp;</gd:btn>
				<a class="easyui-linkbutton" iconCls="icon-reload" onclick="cleardata()">重置</a>
			</div>
			</form>
			<div style="margin-bottom:5px">
				<gd:btn btncode="XTCDGL001"><a class="easyui-linkbutton" iconCls="icon-add" onclick="addAction()">新增</a></gd:btn>
				<gd:btn btncode="XTCDGL003"><a class="easyui-linkbutton" iconCls="icon-remove" onclick="delObj()">删除</a></gd:btn>
            ...
            <table id="dg" title="">
				<thead>
					<tr>
						...
						<th data-options="field:'attribute',width:100,align:'center',sortable:true,formatter: attrformater">菜单类别</th>
