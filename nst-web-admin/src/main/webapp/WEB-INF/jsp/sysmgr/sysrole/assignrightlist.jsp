...
<div id="righttb" style="padding:5px;height:auto">
	...
	<div>
		菜单编号: 
		<input class="easyui-searchbox" type="text" id="menuCode" name="menuCode" style="width:150px" data-options="prompt:'请输入菜单编号',  
           searcher:function(value,name){queryMenu2(value,name)}">
		菜单名称: 
		<input class="easyui-searchbox" type="text" id="menuName" name="menuName" style="width:150px" data-options="prompt:'请输入菜单名称',  
           searcher:function(value,name){queryMenu2(value,name)}">
