...
<div id="roletb" style="padding:5px;height:auto">
	<form id="searchUserForm" method="post">
		<div>
			用户帐号: 
			<input class="easyui-searchbox" type="text" id="userCode" name="userCode" style="width:150px" data-options="prompt:'请输入用户帐号',  
            	searcher:function(value,name){queryUser2(value,name)}">
			用户名称: 
			<input class="easyui-searchbox" type="text" id="userName" name="userName" style="width:150px" data-options="prompt:'请输入用户名称',  
            	searcher:function(value,name){queryUser2(value,name)}">
        	状态: 
