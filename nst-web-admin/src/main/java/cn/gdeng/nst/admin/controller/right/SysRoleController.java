...
import cn.gdeng.nst.admin.service.right.SysRoleService;
import cn.gdeng.nst.entity.nst.SysRole;
import cn.gdeng.nst.entity.nst.SysRoleManager;
...
public class SysRoleController extends AdminBaseController {
    ...
    @ResponseBody
    public String addSysRole(HttpServletRequest request){
        // 取得页面的参数
